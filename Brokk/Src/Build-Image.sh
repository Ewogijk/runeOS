...
RUNE_PARTITION_TYPE_GUID="8fa4455d-2d55-45ba-8bca-cbcedf48bdf6"       # Identifies a partition as being generated by Brokk
BOOT_PARTITION_UNIQUE_GUID="4d3f0533-902a-4642-b125-728c910c1f79"     # Unique partition GUID of the Boot / EFI System partition
GENERIC_PARTITION_UNIQUE_GUID="7574b273-9503-4d83-8617-678d4c2d30c0"  # Unique partition GUID of a Generic partition
...
sgdisk $OUT_FILE \
        ...
        -u 0:$BOOT_PARTITION_UNIQUE_GUID \
        -A 0:set:0 \
        -c 0:Kernel
...
sgdisk $OUT_FILE \
        -n 0:0:0 \
        -t 0:$RUNE_PARTITION_TYPE_GUID \
        -u 0:$GENERIC_PARTITION_UNIQUE_GUID \
        -A 0:set:0 \
        -c 0:Data
