...
class KernelPreBuildStep(Build.BuildStep):
    def _generate_build_variables(self, build_conf: dict[str, Any], kernel_directory: Path) -> bool:
        ...
        with open(build_variables_path, "w") as file:
            ...
            for build_var in build_variables:
                ...
                file.write(f'{build_var.to_scons_key()} = "{build_conf[build_var.to_yaml_key()]}"\n')
        return True
    ...
    def execute(self, build_conf: dict[str, Any]) -> bool:
        ...
        return self._generate_build_variables(build_conf, kernel_directory) and self._generate_macro_defs(
