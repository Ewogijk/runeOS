...
namespace Rune {
    ...
    public:
         ...
         */
        static String format(const String& fmt_str, Argument* args, size_t arg_size);
        ...
        static String format(const String& fmt_str, Args... args) {
            ...
            return format(fmt_str, arg_array, sizeof...(Args));
        }
         ...
         */
        [[nodiscard]] bool starts_with(const String& prefix);
