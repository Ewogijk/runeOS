...
#define VMMStartFailures(X)                             \
    ...
    public:
         ...
         *
         * <p>
         *  The starting addresses of said regions is determined by the given `kSpaceLayout` and combined with the sizes,
         *  the resulting areas will be claimed in the given `VMap`. The `PMap` is used to get the locations of all
         *  regions in the physical memory.
         * </p>
         *
