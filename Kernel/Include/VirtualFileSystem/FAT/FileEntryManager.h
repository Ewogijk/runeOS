...
#define VOLUME_ACCESS_STATUSES(X)                                                                                      \
    ...
    class FileEntryManager {
      ...
      public:
         ...
         * @param out       If the VolumeAccessStatus is Okay, the file entry will be placed in this variable.
         *                  If not the variable is not modified.
         *
         * @return Status of the volume access.
         */
        VolumeAccessStatus
        search(U16 storage_dev, BIOSParameterBlock* bpb, const Path& path, LocationAwareFileEntry& out) const;

        /**
         * Search for the file entry at the given path, check if it is a directory. If yes a coherent range with
         * requested size of empty file entries in the directory will be placed in the out list.
         *
         * <p>
         *  If the directory does not any coherent range of file entries that is big enough, new clusters will be
         *  allocated until the requirement is satisfied.
         * </p>
         *
         * @param storage_dev
         * @param bpb
         ...
         * @param out       Will contain empty file entries that are next to each other oor will not be modified if an
         *                  error occurs.
         *
         * @return Status of the volume access.
         */
        ...
        /**
         * Get the file entry from the storage device that the given entry points to and update it with the content
         * of given entry.
         *
         * @param storage_dev
         * @param bpb
         * @param entry     An file entry with the same path as this one will be searched and updated to exactly match
         *                  this entry.
         *
         ...
         */
        U32
        allocate_cluster(U16 storage_dev, BIOSParameterBlock* bpb, LocationAwareFileEntry& file, U32 last_file_cluster);
    };
} // namespace Rune::VFS
