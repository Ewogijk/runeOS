...
#ifndef HEIMDALL_GNOMEREPORTER_H
#define HEIMDALL_GNOMEREPORTER_H

#include <Test/Heimdall/Reporter.h>

namespace Heimdall {
    /// @brief The GnomeReporter generates an empty Pass.txt file in the test report directory.
    ///         The file is intended to be evaluated by CI pipelines to quickly check if a test run
    ///         is pass or fail.
    class GnomeReporter : public Reporter {
...
#endif // HEIMDALL_GNOMEREPORTER_H
