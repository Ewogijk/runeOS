...
namespace Rune::Device {
    ...
    struct CommandCompletionCoalescingControl {
        ...
        uint32_t INT      : 5;
        /// @brief Command Completions — number of completions to accumulate before asserting the interrupt.
        uint32_t CC       : 8;
    ...
    struct EnclosureManagementControl {
        ...
        uint32_t ATTR_XMT   : 1;
        /// @brief Activity LED Hardware Driven — hardware drives the LED without software intervention.
