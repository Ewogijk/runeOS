...
namespace Rune {
     ...
     * @return
     */
    template <typename T> typename RemoveRef<T>::Type&& move(T&& param) {
    ...
    template <typename F, typename R, typename... A> class Callable : public ICallable<R, A...> {
      ...
      public:
        ...
        R operator()(A... a) const override { return _function(forward<A>(a)...); }

        void copy_to(void* destination) const override { new (destination) Callable(_function); }

        ICallable<R, A...>* clone() const override { return new Callable(_function); }
    };
    ...
    template <typename R, typename... A> class Function<R(A...)> {
      ...
      public:
        ...
        R operator()(A... args) const { return (*_function)(forward<A>(args)...); }
    };
} // namespace Rune
