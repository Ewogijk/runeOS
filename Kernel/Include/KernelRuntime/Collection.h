...
namespace Rune {
    ...
    template <> struct Hash<signed char> {
        ...
        size_t operator()(const signed char& key) const { return key; }
    };
    ...
    template <> struct Hash<char> {
        ...
        size_t operator()(const char& key) const { return key; }
    };
    ...
    template <> struct Hash<short> {
        ...
        size_t operator()(const short& key) const { return key; }
    };
    ...
    template <> struct Hash<long> {
        ...
        size_t operator()(const long& key) const { return key; }
    };
    ...
    template <> struct Hash<long long> {
        ...
        size_t operator()(const long long& key) const { return key; }
    };
    ...
    template <> struct Hash<unsigned char> {
        ...
        size_t operator()(const unsigned char& key) const { return key; }
    };
    ...
    template <> struct Hash<unsigned short> {
        ...
        size_t operator()(const unsigned short& key) const { return key; }
    };
    ...
    template <> struct Hash<unsigned int> {
        ...
        size_t operator()(const unsigned int& key) const { return key; }
    };
    ...
    template <> struct Hash<unsigned long> {
        ...
        size_t operator()(const unsigned long& key) const { return key; }
    };
    ...
    template <> struct Hash<unsigned long long> {
        ...
        size_t operator()(const unsigned long long& key) const { return key; }
    };
    ...
    template <> struct Hash<bool> {
        ...
        size_t operator()(const bool& key) const { return (size_t) key; }
    };
    ...
    template <typename K, typename V> class HashMapIterator {
      ...
      public:
        ...
        const Pair<K, V>& operator*() const { return _pair; }

        const Pair<K, V>* operator->() const { return _current ? &_pair : nullptr; }
        ...
        HashMapIterator<K, V>& operator++() {
            ...
            if (!_current) _bucket_pos = _bucket_count;
    ...
    template <typename K, typename V> class HashMap {
        ...
        size_t calc_hash(const K& key, size_t size) const { return _hash(key) % size; }
        ...
        HashMapIterator<K, V> put0(HashNode<K, V>* node) {
            if ((double) (_size + 1) / _bucket_count > _load_factor) rehash(2 * _bucket_count);
        ...
        void copy(const HashMap<K, V>& o) {
            ...
            for (size_t i = 0; i < _bucket_count; i++) {
                ...
                while (o_curr) {
                    ...
                    if (t_prev != nullptr) t_prev->next = t_curr;

                    if (o_curr == o._bucket[i]) _bucket[i] = t_curr;
      ...
      public:
        ...
        HashMapIterator<K, V> begin() const {
            ...
            for (size_t i = 0; i < _bucket_count; i++)
                if (_bucket[i]) return HashMapIterator<K, V>(_bucket, _bucket_count, i, _bucket[i]);
            return end();
        }
    ...
    template <typename T> class LinkedListIterator {
      ...
      public:
        ...
        T& operator*() const { return _current->element; }

        T* operator->() const { return _current ? &_current->element : nullptr; }
        ...
        bool operator==(const LinkedListIterator& o) const { return _current == o._current; }
    ...
    template <typename T> class LinkedList {
        ...
        bool remove0(Node<T>* node) {
            ...
            if (node->next == nullptr && node->previous == nullptr) _head = _tail = nullptr;
        ...
        void copy(const LinkedList<T>& o) {
            ...
            while (o_curr) {
                ...
                if (o_curr == o._head) _head = t_curr;
                if (o_curr == o._tail) _tail = t_curr;
      ...
      public:
        ...
        LinkedList(const LinkedList<T>& o) noexcept : _size(0) { copy(o); }
         ...
         */
        bool remove_front() { return remove0(_head); }

        /**
         * Remove the last element.
         */
        bool remove_back() { return remove0(_tail); }
         ...
         */
        bool contains(const T& element) { return contains0(element); }

        /**
         *
         * @return True: The element is in the list, False: Is not in the list.
         */
        bool contains(T&& element) { return contains0(element); }
        ...
        LinkedListIterator<T> begin() const { return LinkedListIterator<T>(_head); }
