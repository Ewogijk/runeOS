...
namespace Rune::CPU {
    ...
    void X64Core::dump_core_state(const SharedPointer<TextStream>& stream,
        ...
        stream->write_formatted("-------------------------------------------- CPU{} Core Dump "
                                "--------------------------------------------\n",
                                _core_id);
        stream->write_formatted("rax={:0=#16x}, rbx={:0=#16x}, rcx={:0=#16x}, rdx={:0=#16x}\n",
                                state.RAX,
                                state.RBX,
                                state.RCX,
                                state.RDX);
        stream->write_formatted("rsi={:0=#16x}, rdi={:0=#16x}, rbp={:0=#16x}, rsp={:0=#16x}\n",
                                state.RSI,
                                state.RDI,
                                state.RBP,
                                state.RSP);
        stream->write_formatted("r8 ={:0=#16x}, r9 ={:0=#16x}, r10={:0=#16x}, r11={:0=#16x}\n",
                                state.R8,
                                state.R9,
                                state.R10,
                                state.R11);
        stream->write_formatted("r12={:0=#16x}, r13={:0=#16x}, r14={:0=#16x}, r15={:0=#16x}\n",
                                state.R12,
                                state.R13,
                                state.R14,
                                state.R15);
        stream->write_formatted(
            ...
            state.RIP,
            state.RFlags);
        stream->write_formatted("cr0={:0=#16x}, cr2={:0=#16x}, cr3={:0=#16x}, cr4={:0=#16x}\n",
                                state.CR0,
                                state.CR2,
                                state.CR3,
                                state.CR4);
        ...
        stream->write_formatted("KernelGSBase={:0=#16x} ({:0=#16x})\n",
                                read_msr(ModelSpecificRegister::KERNEL_GS_BASE),
                                _kgs_base);
        stream->write_formatted("GSBase      ={:0=#16x} ({:0=#16x})\n",
