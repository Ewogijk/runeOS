...
namespace Rune::Device {
    DEFINE_ENUM(BaseClass, BASE_CLASS_CODES, 0xFF)
    ...
    DEFINE_ENUM(SerialBusSubClass, SERIAL_BUS_SUB_CLASS_CODES, 0xFF)
    DEFINE_ENUM(FireWireProgrammingInterface, FIREWIRE_PROGRAMMING_INTERFACE_CODES, 0xFF)
    DEFINE_ENUM(USBProgrammingInterface, USB_PROGRAMMING_INTERFACE_CODES, 0xFF)
