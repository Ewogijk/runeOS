...
namespace Rune::Device {
    ...
    auto PCI::read_byte(U8 bus, U8 device, U8 func, U8 offset) -> U8 {
    ...
    void PCI::write_byte(U8 bus, U8 device, U8 func, U8 offset, U8 value) {
        CPU::out_dw(PCI_CONFIG,
                    (1 << ENABLE_BIT_SHIFT | (bus << BUS_NUMBER_SHIFT)
                     | (device << DEVICE_NUMBER_SHIFT) | (func << FUNCTION_NUMBER_SHIFT)
                     | (offset & REGISTER_OFFSET_MASK)));
    ...
    auto PCI::read_word(U8 bus, U8 device, U8 func, U8 offset) -> U16 {
        if ((offset & 0x03) > 2) {
    ...
    void PCI::write_word(U8 bus, U8 device, U8 func, U8 offset, U16 value) {
        if ((offset & 0x03) > 2) {
    ...
    auto PCI::read_dword(U8 bus, U8 device, U8 func, U8 offset) -> U32 {
        if ((offset & 0x03) > 0) {
    ...
    void PCI::write_dword(U8 bus, U8 device, U8 func, U8 offset, U32 value) {
        if ((offset & 0x03) > 2) {
    ...
    auto PCI::read_header(U8 bus, U8 device, U8 func) -> PCIHeader {
    ...
    void PCI::check_device(AHCIDriver& ahci_driver, U8 bus, U8 device) {
        ...
        if ((header.header_type & MULTI_FUNCTION_DEVICE) != 0) {
            for (U8 func = 1; func < FUNC_LIMIT; func++) {
                ...
                LOGGER->debug("Bus: {}, Device: {}, Function: {} - {:#x}:{:#x} - Base Class "
                              "Code: {:#x} - Sub "
    ...
    void PCI::discover_devices(AHCIDriver& ahci_driver) {
