...
namespace Rune::VFS {
    ...
    bool VolumeManager::fat_write(U16                 storage_dev,
    ...
    bool VolumeManager::data_cluster_read(U16                      storage_dev,
    ...
    bool VolumeManager::data_cluster_write(U16                      storage_dev,
                                           VFS::BIOSParameterBlock* bpb,
                                           void*                    buf,
                                           size_t                   cluster) {
        U32 cluster_size = bpb->bytes_per_sector * bpb->sectors_per_cluster;
        return _ahci_driver.write(storage_dev, buf, cluster_size, data_cluster_to_lba(bpb, cluster))
               == cluster_size;
    }
